...
namespace Pisheyar.Application.Posts.Queries.GetMonthlyMostViewedPosts
{
    public class GetMonthlyMostViewedPostsDto : IMapFrom<Post>
    {
        public Guid PostGuid { get; set; }

        public FilepondDto Document { get; set; }

        public GetMonthlyMostViewedPostsCategoryNameDto Category { get; set; }

        public List<GetMonthlyMostViewedPostsTagNameDto> Tags { get; set; }
    ...
    public class GetMonthlyMostViewedPostsCategoryNameDto
    {
    ...
    public class GetMonthlyMostViewedPostsTagNameDto
    {
        public Guid Guid { get; set; }
